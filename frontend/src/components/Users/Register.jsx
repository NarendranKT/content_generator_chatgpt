...
const Register = () => {
  ...
  //Redirect if a user is login
    ...
    if (mutation.isSuccess && (!mutation.isError && !mutation.isSuccess && !mutation.isIdle)) {
    ...
    return (
    <>
        <div className="min-h-screen flex justify-center items-center bg-gray-900 text-white tracking-wide pt-[70px]">
            <div className="lg:max-w-lg max-w-md w-full bg-white/10 rounded-lg shadow-md p-8 m-4s py-10">
                <h2 className="text-center lg:text-4xl text-2xl font-bold mb-4">Create an Account</h2>
                <p className="text-center text-gray-200 mb-8 text-sm lg:text-base">Create an account to get free access for 3 days. No credit card required</p>
                ...
                <form onSubmit={formik.handleSubmit} className=" s">
                    <div className="capitalize mb-5">
                        ...
                        <input className="w-full rounded-md py-2 px-4 placeholder-white/50 placeholder:text-sm focus:outline-none bg-white/5 border border-gray-400" type="text" 
                        id="username"
                        placeholder="Joe"
                        autoComplete="off"
                    ...
                    <div className="flex flex-col items-center justify-center text-center">
                        ...
                        <div className="mt-3 tracking-wider">
                            ...
                            <Link className="font-medium underline hover:text-white/85" to='/login'>Sign in</Link>
                        </div>
                    </div>
                </form>
            </div>
